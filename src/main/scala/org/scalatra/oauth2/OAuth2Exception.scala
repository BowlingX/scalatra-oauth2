...
abstract class OAuth2Exception(
              ...
              */
             val redirectUri: Option[URI] = None) extends RuntimeException {
  ...
  def toRedirecUrl(responseType: Option[ResponseType.ResponseType] = None) = {
  ...
  override def getMessage = description getOrElse "Unknown OAuth 2 problem"
}
...
case class AccessDeniedException(
    ...
    extends OAuth2Exception(OAuth2Error.AccessDenied, state, Some("You are not allowed to access this resource."), uri, redirectUri)

/**
 * Access token expired, client expected to request new one using refresh token.
 */
case class ExpiredTokenException(
              override val state: Option[String],
              override val uri: Option[String] = None,
              override val redirectUri: Option[URI] = None)
    extends OAuth2Exception(OAuth2Error.ExpiredToken, state, Some("The access token has expired."), uri, redirectUri)
 ...
 */
case class InvalidClientException(
             override val state: Option[String],
             override val uri: Option[String] = None,
             override val redirectUri: Option[URI] = None)
    extends OAuth2Exception(OAuth2Error.InvalidClient, state, Some("Client ID and client secret do not match."), uri, redirectUri)
 ...
 */
case class InvalidGrantException(
             override val state: Option[String],
             override val description: Option[String] = None,
             override val uri: Option[String] = None,
             override val redirectUri: Option[URI] = None)
    extends OAuth2Exception(OAuth2Error.InvalidGrant, state, Some(description getOrElse "This access grant is no longer valid."), uri, redirectUri)
...
case class InvalidRequestException(
             ...
             override val uri: Option[String] = None,
             override val redirectUri: Option[URI] = None)
    extends OAuth2Exception(OAuth2Error.InvalidRequest, state, Some(description getOrElse "The request has the wrong parameters."), uri, redirectUri)

/** The requested scope is invalid, unknown, or malformed. */
case class InvalidScopeException(
             override val state: Option[String],
             override val uri: Option[String] = None,
             override val redirectUri: Option[URI] = None)
    extends OAuth2Exception(OAuth2Error.InvalidScope, state, Some("The requested scope is not supported."), uri, redirectUri)

/** The authenticated client is not authorized to use the access grant type provided. */
case class UnauthorizedClientException(
             override val state: Option[String],
             override val uri: Option[String] = None,
             override val redirectUri: Option[URI] = None)
    extends OAuth2Exception(OAuth2Error.UnauthorizedClient, state, Some("You are not allowed to access this resource."), uri, redirectUri)

/** This access grant type is not supported by this server. */
case class UnsupportedGrantTypeException(
             override val state: Option[String],
             override val uri: Option[String] = None,
             override val redirectUri: Option[URI] = None)
    extends OAuth2Exception(OAuth2Error.UnsupportedGrantType, state, Some("This access grant type is not supported by this server."), uri, redirectUri)

/** The requested response type is not supported by the authorization server. */
case class UnsupportedResponseTypeException(
             override val state: Option[String],
             override val uri: Option[String] = None,
             override val redirectUri: Option[URI] = None)
    extends OAuth2Exception(OAuth2Error.UnsupportedResponseType, state, Some("The requested response type is not supported."), uri, redirectUri)
